class LinearWithPlateaus:
    ...
    def __init__(self, start_val, end_val, steps_total, rel_length_start_plateau=0.0, rel_length_end_plateau=0.0):
        self.start_val = start_val
        self.end_val = end_val
        self.steps_total = steps_total
        self.plateau_start_steps = steps_total * rel_length_start_plateau
        self.plateau_end_steps = steps_total * rel_length_end_plateau
